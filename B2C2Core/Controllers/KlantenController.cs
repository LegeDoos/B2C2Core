...
namespace B2C2Core.Controllers
{
    public class KlantenController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Naam")] Klant klant)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Naam")] Klant klant)
        {
            if (id != klant.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'AppDbContext.Klant'  is null.");
            }
            var klant = await _context.Klant.FindAsync(id);
            if (klant != null)
            {
